  ...
  constraint t_colaborador_department_check check (
    (
      (department)::text = any (
        (
          array[
            'AUDIOVISUAL'::character varying,
            'DESIGN'::character varying,
            'STRATEGIC_MANAGER'::character varying,
            ...
            'HUMAN_RESOURCES'::character varying,
      ...
      (level)::text = any (
        (
          array[
            ...
            'JUNIOR_EAGLE'::character varying,
            'MID_LEVEL_EAGLE'::character varying,
            'SENIOR_EAGLE'::character varying,
            'JUNIOR_HIGH_EAGLE'::character varying,
            'MID_LEVEL_HIGH_EAGLE'::character varying,
            'SENIOR_HIGH_LEVEL'::character varying,
